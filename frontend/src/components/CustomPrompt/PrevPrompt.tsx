...
const PrevPrompt = () => {
  ...
  return (
    <div className="flex flex-col ">
      <div className="flex mr-5 mt-3 justify-end font-bold text-sm text-primary-500">
        현재 저장된 프롬프트
      </div>
      <div className="rounded-lg  text-primary-500 p-4 mt-2 mb-4 max-h-[300px] overflow-y-auto">
        <div
