    ...
    <div className="flex flex-col flex-grow overflow-auto p-4 gap-8 min-w-[1000px] min-h-[700px] max-w-[2000px] max-h-[1200px]">
      ...
      <div className="flex flex-row h-[45%] gap-4">
        ...
        <div className="flex flex-col flex-[3] min-w-[570px] min-h-[400px]">
          ...
          <div
            ref={containerRef}
            className="flex-grow bg-primary-100/20 border-2 border-secondary rounded-lg flex items-center justify-center p-4"
          >
            <ChartBox
              chartType="radar"
              data={radarData}
        ...
        <div className="flex flex-col flex-[2] min-w-[380px] min-h-[400px]">
          ...
          <div className="flex-grow p-4 bg-primary-100/20 border-2 border-secondary rounded-lg">
      ...
      <div className="flex flex-row h-[45%] gap-4">
        ...
        <div className="flex flex-col flex-[3] min-w-[570px] min-h-[400px]">
          ...
          <div className="flex-grow bg-primary-100/20 border-2 border-secondary rounded-lg items-center justify-center p-4">
