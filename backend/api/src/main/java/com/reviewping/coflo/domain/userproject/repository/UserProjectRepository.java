...
public interface UserProjectRepository extends JpaRepository<UserProject, Long>, UserProjectRepositoryCustom {
    ...
    Optional<UserProject> findByProjectAndGitlabAccount(Project project, GitlabAccount gitlabAccount);
    ...
    @Query("SELECT up FROM UserProject up JOIN up.gitlabAccount gl JOIN gl.user u "
