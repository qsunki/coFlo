...
public class ProjectDateUtil {
     ...
     * @return 시작일, 종료일
     */
    public LocalDate[] calculateWeekStartAndEndDates(LocalDate projectCreatedDate, LocalDate currentDate) {
    ...
    public ProjectWeek calculateWeekRange(LocalDate projectCreatedDate, int period, LocalDate currentDate) {
        ...
        LocalDate endDate = projectStartMonday
                .plusWeeks(endWeek - 1)
