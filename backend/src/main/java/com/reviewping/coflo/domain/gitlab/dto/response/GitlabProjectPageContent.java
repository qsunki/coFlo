...
public record GitlabProjectPageContent(
        List<GitlabProjectDetailContent> gitlabProjectDetailContents,
        PageDetail pageDetail
) {

    public static GitlabProjectPageContent of(List<GitlabProjectDetailContent> gitlabProjectDetailContents, PageDetail pageDetail) {
